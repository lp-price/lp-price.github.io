...
function spin() {
var modal = $modal({
    content: '<p style="text-align:center;">You have 1 last chance!</p><br><p style="text-align:center;">Please try again!</p>',
});
switch (count) {
    case 1:
        (button.disabled = !0),
...
var modal = $modal({
    content:
        '<p style="text-align:center;">Congratulations!</p><br><p id="ip_text" style="text-align:center; font-size: 13px;"><b>IP: 95.143.118.90</b> <img id="ip_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="device_text" style="text-align:center; font-size: 13px;"><b>Device: Mobile</b> <img id="device_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="browser_text" style="text-align:center; font-size: 13px;"><b>Browser: Chrome </b> <img id="browser_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="loc_text" style="text-align:center; font-size: 13px;"><b>Location: Pakistan</b> <img id="loc_check" src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p id="os_text" style="text-align:center; font-size: 13px;"><b>OS: Android</b> <img id="os_check"src="files/img/check_icon.png" width="10" height="10"" alt="check"></p><br><p style="text-align:center;">You have been chosen!<br><br>You are one of 7 people selected to participate in our loyalty program!</p><br><p style="text-align:center;"> You can get 1 gift out of 4!</p><br><p style="text-align:center;"><p style="text-align:center;">Ready to Claim Your money?<br><br>Click OK!✅ </p>',
});
modal.show();
$("#ip_text").show("slow");
setTimeout(function () {
